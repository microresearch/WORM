...
#define TMS_VOCAB 65 // TOTAL
#define TMS_VOCAB_TOP 64 // 0-
#define TMS_VOCAB_F 68.0f 
#define ALLPHON_BANK 49 // CHECKed - but moved alphon!
#define EXTRAX 55 // this is the extra vocab - replaced

// group first 5100:

// refreshing
#include "LPC/roms/vocab_spkspellone.h" // wordlist_spell1[154] // not match new one 0use -> 153today // duplicates in 2303/2404
#include "LPC/roms/vocab_spkspelltwo.h" // wordlist_spell2[124] // as above spkspell.h is both of these now split
//
// check repeats against above and also SPELLEN
#include "LPC/roms/vocab_2303.h" // wordlist_spell2303[102] - check this starts with "I" -> "lINGER" - checked // checked but odd against new version
//#include "LPC/roms/vocab_2304.h" // wordlist_spell2304[132] // checked 2024 but odd against new version
#include "LPC/roms/vocab_2350.h" // wordlist_spell2350[152] // usa // checked 2024
//#include "LPC/roms/vocab_2321.h" // wordlist_spell2321[98] // usa/japan // checked 2024 some repeats against 2303 to check
//#include "LPC/roms/vocab_2322.h" // wordlist_spell2322[127] // usa/japan ok // not so exciting
#include "LPC/roms/vocab_2352.h" // wordlist_spell2352[144] // french - fixed but we have potential new additions and check repeats

// adding in 2024 vocabs - make space
#include "LPC/roms/vocaid.h"
//#include "LPC/roms/tntell_ET.h"
// then 5200
...
const TMS_vocab vocab_2303={wordlist_spell2303, &T0280B_0281A_coeff, 87, 91.0f}; // en - OK and not 2801!
...
const TMS_vocab vocab_2350_2={wordlist_spell2350_2, &T0280B_0281A_coeff, 74, 78.0f}; 
...
const TMS_vocab vocab_2352_2={wordlist_spell2352_2, &T0280F_2801A_coeff, 66, 70.0f}; 

const TMS_vocab vocab_spkspellone_1={wordlist_spell1_1, &T0280B_0281A_coeff, 74, 78.0f}; //all 5100
const TMS_vocab vocab_spkspellone_2={wordlist_spell1_2, &T0280B_0281A_coeff, 60, 64.0f}; //

const TMS_vocab vocab_spkspelltwo_1={wordlist_spell2_1, &T0280B_0281A_coeff, 82, 86.0f};//
const TMS_vocab vocab_spkspelltwo_2={wordlist_spell2_2, &T0280B_0281A_coeff, 83, 87.0f};//
...
const TMS_vocab vocab_acorn_1={wordlist_acorn_1, &tms5220_coeff, 80, 83.0f}; //5220
...
const TMS_vocab vocab_vocaid={wordlist_spellvocaid, &T0280F_2801A_coeff, 122, 125.0f}; // NEW 2024
//const TMS_vocab vocab_tntellET={wordlist_tntellET, &T0280F_2801A_coeff, 94, 97.0f}; // 


const TMS_vocab *allTMSvocabs[TMS_VOCAB]={&vocab_2303, &vocab_2350_1, &vocab_2350_2, &vocab_2352_1, &vocab_2352_2, &vocab_spkspellone_1, &vocab_spkspellone_2, &vocab_spkspelltwo_1, &vocab_spkspelltwo_2, &vocab_D000_1, &vocab_D000_2, &vocab_D001_1, &vocab_D001_2, &vocab_D002_1, &vocab_D002_2, &vocab_D003, &vocab_D004_1, &vocab_D004_2, &vocab_D005_1, &vocab_D005_2, &vocab_D006_1, &vocab_D006_2, &vocab_D007_1, &vocab_D007_2, &vocab_D008, &vocab_D009_1, &vocab_D009_2, &vocab_D010_1, &vocab_D010_2, &vocab_D011, &vocab_D012_1, &vocab_D012_2, &vocab_D013, &vocab_D014, &vocab_D015_1, &vocab_D015_2, &vocab_D016, &vocab_D017, &vocab_D018, &vocab_D019, &vocab_D020_21, &vocab_D022, &vocab_D023, &vocab_D024_25, &vocab_D026, &vocab_D027_34, &vocab_echofemale_1, &vocab_echofemale_2, &vocab_mpf, &vocab_alphons, &vocab_arcade_one, &vocab_arcade_two, &vocab_ti99_one_1, &vocab_ti99_one_2, &vocab_ti99_two_1, &vocab_ti99_two_2, &vocab_acorn_1, &vocab_acorn_2, &vocab_large_male_one_1, &vocab_large_male_one_2, &vocab_large_male_two_1, &vocab_large_male_two_2, &vocab_male_1, &vocab_male_2, &vocab_vocaid}; // 65
  ...
  static u8 counter;
	...
	int16_t sample, val;
		...
		if ((m_IP == 0) && (m_PC == 12) && (m_subcycle == 1))
		{
			...
			for (i = 4; i < m_coeff->num_k; i++)
			  m_target_k[i] = (m_coeff->ktable[i][m_new_frame_k_idx[i]] * (1-zpar)*(2.0f*(exy[koffset[i]+m_new_frame_k_idx[i]]+0.1f))); // ktable size is 168
