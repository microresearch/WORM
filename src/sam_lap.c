...
//standard sam sound
//char input[256]={"/HEH3LOW2, /HAW AH YUX2 TUXDEY. AY /HOH3P YUX AH FIYLIHNX OW4 KEY.\x9b\x9b"};
...
void SetSpeed(unsigned char _speed) {speedd = _speed;};
 ...
 fprintf(stderr,"ERR: \n");
  ...
  phonemeindex[255] = 255; //to prevent buffer overflow or 255
    ...
    if (A == 254)
	{
	  ...
	  // this shouldn't be done before samples - but once we have rendered frame
	  //	  X=temp;
	  Y = 0;
	  //	  inphoneme=1;
	  //	  renderupdate();
