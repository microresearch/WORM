...
UINT32 getb( int len )
{
	...
	} else
	{
		...
		int firstadd=(idx0 & 0xffff)-0x1000;
		int secondadd=(idx1 & 0xffff)-0x1000;

		if (firstadd<0 || secondadd>0x1000) data=0; // better check on this
		else
		  {
		d0 = m_rom[firstadd];
