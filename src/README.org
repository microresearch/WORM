...
*do we we need seperate samplepos in audio.c for each generator?* REMOVED///RE_TEST

- check sanity interpol DONE - and need to fix audio.c

- re-check sample size in sam
...
- or port tms5110x.c which should not be necessary

- sp0256 roms and vocabularies - and how works with 2/3 bitshift re-acquaint - sp0256lap? ./sp0256 ... document this!

- tubes.c and do we ignore nvp.c ?
...
* roms - ti99/apple/games/speak and spell
