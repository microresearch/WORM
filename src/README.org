...
- check again nvp and simpleklatt as to how these differ from full klatt
...
reduce PCB and panel to 12HP

- modes: 1-klatt//2-klatt raw params//3-talkie-how to change
