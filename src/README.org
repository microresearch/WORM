...
- also general TODO eg. text decimation interpol, cosf and sinf speedups, triggerQ, our own synthetic mode?

- also general model for division of potential sources/and/filters and knobs throughout

- all notes/raven progress noted BELOW - nearly done
...
- 2mass IF model - balloon -> raven.c - DOUBLE issue, IF_final.m, 

- plague model

- LF - lfgen.c=more rosenberg well rest is commented out, flowgen_shimmer
