...
see also phoneme sample version at: [[file:~/Downloads/stuff.mit.edu/afs/athena/astaff/project/phones/Speak/speak.c]]
...
- 2. 16 channel bandpass/formant/vocoder: ladspa DONE= vocoder.c //pv is not fully functional

or vst-mda version: mdaVocoder.cpp TEST/TRY mdavoc=input and mdavocoder? see effect.c
...
- formant frequency/vowel table (vowels announced from buf16 as text->vowels,Q,length of vowel?) ????===arm_biquad_cascade_df1_init_f32??? in main.c in DI
