...
pitch track, raven/glottis models, decimation filter tests, generate and collect wavetables

///

- raven/syrinx/glottis models below to work through:

Ishizaka Flanagan=IF: raven.c - question of parameters and double but could be used for wavetables????

LF and others: lfgen.c = now test code in lfgen2.c is working 
Rosenberg in lfgen

glottalair.py = klglot88? PORTED
