...
- TODO: test TRIGGER IN! how?

- in talkie pitch mod is just over/undersampling which we kind of
  have, other mods to do with mapping, repeats etc and speed
...
- test trigger in and check CVs/PCB->check/order

- finish LPC vocabulary

- new sp0256 and vocab // digitalk/s14001a?

- test and evaluate all algos

- controls X,Y.Z and mode rundown

- wormcode and how fits with modes

- trigger scheme and code - trigger RESTART of algo/generator on IN
