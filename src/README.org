...
figure out also how klatts and online parwave.c // latest rsynth also
...
- nvp.c half through porting is also a much simpler klatt...
...
- in mage video - wheel for repeating phoneme loop selection to maybe implement
