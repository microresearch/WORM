...
1/port simple klatt and add constraints (test first on laptop->see genparam.cDONE): simpleklatt.c

2/round phonemes for klatt in mainbuffer simply

3/finish port and test nvp.c
