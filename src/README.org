...
*CHECK: blip.ar - fill out with same table in scformant.c, STARTED but not got so far*
...
TODO: rendervowel in braidworm and multiples of FOF in braidworm
...
sc vosim is vosim.c = strange parameters and ONE vosim TESTED
braids RenderVosim is 2 vosims and can be increased but both have same delay characteristics TESTED
braids rendervowel is 3 fofs and noise TEST
