...
- testing lpcana and lpcsyn with diff inputs, some changes ..

: sox joe_noise.wav -b 16 -t raw nn gain -10 rate 16000
...
- SPASM - tract stuff in [[file:~/projects/ERD_modules/worm/docs/Lua2SC/lua2SC/lua/num]] :
...
http://apt-browse.org/browse/debian/wheezy/main/all/snd/11.7-2/file/usr/share/snd/singer.scm

clm bird and animals

- how SPASM/singer.ins squares with APEX=ntube/tube/lua/what else?

- voicform? and tables we have in collated_forms

- compile and test APEX/and/or/ntube? where are ntube/sc examples?

[[file:~/sc3-plugins/source/SLUGens/sc/HelpSource/Classes/NTube.schelp]]
