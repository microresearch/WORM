...
and codes from dumpspch don;t match at all R or P or... - XLAT, SPEAK in machine language?
...
in spchrom is word then 5,,,, then address...

seems like can have REPEAT bit at start with on coeffs>>??

had to NOT reverse bits (and also wh we need to reverse - just do for all arrays beforehand!)
