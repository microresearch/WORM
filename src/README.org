...
- flowgen_shimmer in voice_synth in docs - Fant model

- http://homepage.univie.ac.at/christian.herbst//python/glottal_air_flow_models_8py_source.html = KLGLOTT88 and Rosenberg

now as glottalair.py and writing wav file - seems working -> port to C (also Rosenberg tests in lfgen.c)

- others: wavetable, formants a la SINGER/SPASM -> where? check VOICFORM again, LPC
