...
vocab from: [[file:~/projects/ERD_modules/older/euro-modules/Talko/Software/TalkoVCO/TalkoVCO.ino]]

from where else? arcade games/roms

compare Talkie to MAME code...
...
3. two mass model - Ishizaka and Flanagan, Fletcher (Ravens)= Fletcher1988.pdf for glottis ponly
...
articulatory models: APEX?(VocalTractExample?): based on KLvocaltract based on http://doc.sccode.org/Classes/NTube.html
...
- lpc dir from SLP book - TODO: run commandline tests from docs/SLP, fix mallocs, work in
...
tested with var excitations but no luck
