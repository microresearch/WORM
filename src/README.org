...
- test code different excitations - list here: pulses, vosim/decaying sines, square/triangle // what else?
...
**** tweaks for each mode/generation
...
- run through TODO for every mode (eg. X/Y we need scaling of
  formants/vocal tract size

- general mode tweaks and wormings for each mode
...
- list modes/chips/files and notes/authors so far:

MODE | IS? | FILES/DIR | BASED_ON | NOTES/TODO - to add to TODO from above
...
12-  | borboom vocoder | vocoder/vocode.c | borboom | try with ARM FFT?
