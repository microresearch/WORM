...
- BRING IN larger vocab from:   /root/projects/earthvoice2/Talkie-LPCcode/Talkie/examples DONEorNOT?
...
- cleanup new vocabulary and groupings of -> now in files but we need to define banks of 64 (how many)
