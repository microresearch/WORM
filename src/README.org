...
also multipliers and frame param over-rides for different voices
...
// use nvp model of running -> larger buffer and schedule frame updates in round style again
