...
- generator for random/wormed LPC/TMS5220

- interpolation and general stuff

- each mode before worming part finalised

- worm constraints not limits for each parameter table - so morelike scaling?

- ported simpleklatt to generator - TO TEST and fix K0 problem in genparam - don't worry about this for moment
...
- port to generatorDONE -> to TEST!

- how we break this out to knobs X/Y select and val as Z

- how we get nvp.c array?
