...
softwares, worms, bends, twists and break a total of XXX well-known
and media-historical speech codecs
...
TI singing desc: The pitch is how high or low the voice sounds and can be a number from
...
s// Additional External 16KiB speech ROM (spr128-004) from S.I.D. the Spellbinder
