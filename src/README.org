...
- vocoder with compost or with live generation of selected algos as VOICE and with INPUt as INSTRUMENT//EXCITATION
...
*** soundfun - and where else we had tau calc=lfgen/glottalsources
...
*** start on modes - heading back into wavetables to work with SIR
...
- but we need to update all generators for this - lpc/c/TMS-done!
