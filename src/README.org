...
Also seems like common to some effects that we would 

*** TODO: - PRIORITISE: vocoder and X/Y// changes/TODO as above and all tests
...
- other speech synths ported and look at propellor/cordic thing

- klatt as singing - constant sounds?

SAM: http://www.retrobits.net/atari/sam.shtml
