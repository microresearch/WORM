...
still no luck with inverse filtering 

** 30/7

- lpc4.c inverse filtering and cross-over done - CAN also do pitch
  tracking and shifting/lagging based on fitlpc.c and associated code
...
+ morph data we have from ROMS, and also generation of new data on this model...
