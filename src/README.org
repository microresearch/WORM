...
// workflow for wavetables: praat inverse filter, audacity, dump to float? how to fix lengths? 32k samplerate
...
nfcascade (how man cascading resonators): rsynth=2?, nvp=6 resonators
all pre-set, simpleklatt=parwave/we set to ALL PARALLEL so NO
cascade...
...
- added experimental crow wavetable but could be a bit slower...
...
- physical/other models of raven
...
- basic wormed wavetablesDONE and 2d wormed wavetables
...
- generation of say raven wavetables using LPC/inverse filtering - lpcforlap.c and praat
