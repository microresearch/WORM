...
- tweak speeds for each mode?

lis of new TMS modes - any easier way to template these?

- extra subsections of vocabs with both bends TODO - which vocabs? - allphons we have already and ...
- X/Y bends on subsection of vocab TODO also 5100 - which vocabs? - allphonsDONE (5200)
- 5200 variants of table bends which work = pitchtable and ktable and watch newsay for these when add rest of vocabs
- bend pitchtable AND ktable at same time

- *so all bends with fixed vocabs*
...
//////////////////say 27 so far - we have 23 with maybe 4 more to come
