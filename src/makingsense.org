...
- checked all resets - fixed in simpleklattDONE-TEST!, in klattTEST, in rsynthTEST, in votraxTEST

checked nvp, tms, digi, sp0256

- check fast triggering and changing between modes - re-check all modes!
