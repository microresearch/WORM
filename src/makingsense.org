...
- policy for extents (how far we go beyond and does it wrap or something in any cases?)

// some kind of extent test code = clear vocab as best - for ssay 150 we need to +4 - test on other hardware
...
*- TMS: test coeff switching - do we need to reset?*
