...
- fixed compost bugs for reversing 

- TODO:  add interpolation on compost writing based on samplerate.c so is not so fast

- TODO: see how much we need to trim from TMS vocabs to make it fit with full list of say 64 modes
