...
-- klatt: // and still some clicks in 48klatt/nelm list - def_pars.c
...
*- still check all length long->short (fixed for all klatts and few others)*
...
*- all klatt extra voices as above*

- where we are at with modes and development (also HW-builds/tests)?
