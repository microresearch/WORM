...
- speed is /128 there but for 8k samplerate so /32
...
- digitalker basic mode with bends
- digitalker - added new roms to sort = length of vocabs and how these are addressed

- start on Klatt - define all kaltt sub-types (eg. nvp, simpleklatt, TTS there etc.)
