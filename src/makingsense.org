...
very own touch-based voice synthesizer will take place in London in a
few weeks:
...
Pricing: 265 euros with free, tracked worldwide shipping. x in stock of first batch.
...
Manual and layout at: ErdWormOnlinewhite.pdf and github
...
- release: manual online, modulargrid, web page, mailing list, muffwiggler, soundcloud

// 5/12 - check compostmodef start/trigger code? TEST!
