...
- added rsynth/opsynth(below) to audio.c TO TEST!

** 23/3+

*- Q of len-1 for input in TTS/parse.c? for most gens*

- test new rsynth

- vocabs for nvp and klatt 0 implement and test vocab lists selection

for nvp:  python test_speakIpa.py with list in /root/test

for klatt: list is also in /root/test and run with in rsynth-2-un/rsynth-2.0 ./say
