...
- re-check all FIXED modes above

- check compost/checked sanity but check operations

finally remove TESTY -> full tests, uncomment retrigger code

- announce OCT - soundcloud=more recordings/instagram/twitter/mail-list/muffs
