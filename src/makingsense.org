...
- XYZ for each in co-ordinate and bends (x pitch, y other, z- length of sample)
and eg. for sp0256:   // selx,y,z-> x-axis for amp, 12x filt-coef, on/off for noise, y for value, z for period/pitch!

how we do that mapping - port sp0256_lapraw1 to ARM and finish both raw attempts, TEST!

- sp0256 vocab-split and test
