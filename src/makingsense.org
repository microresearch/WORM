...
- TODO: note also with votrax clock change on cap filters - as extra bend


- new bends/TMS modes in tms5200x.h to incorporate in audio.c, TEST and select/add new vocabs
