...
- for multiple bends (eg x/y bends) we need stock vocab rather than all banks
...
also more general (for sp0256, votrax also) is if bends are applied continuously or to new phoneme?
