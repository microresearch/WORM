...
- where is TRON=sp0256 (work on those when we get to that)
...
- TTS votrax with multiples?

- test votrax vocabs and do as newsay
...
- what are the bends? - sp0256 pitch should subtract
...
- new lpcreader to get roms - 3150,3220 for ti99 - sewermania and microsurgeon
