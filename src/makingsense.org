...
- *fixed major bug in TTS with char/counter - still to test ALL!*

- retrigger also of TTS to test!

- sp0256: test RAW and bend, ADC extents, triggers

- check again how ADC works with CV in...

- re-test all sp0256 modes and extents

- new hardware tests for ADC extents - extra board
