...
-- seems a bit volatile on bends - and reset volume always adds click... - gain control in window???

- bends CRASH - FIXED but esp. bend is quite dull, also extent of tubes.c postures is quite high...
