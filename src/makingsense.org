...
- add 5220 bend mode (simply copy but when we are happy with X/Y - changed to trigger as freeze/unfreeze)
...
++ bends of tables on specific vocabs. tables are: energy, pitch, LPC and chirp - bend all of just 1?
