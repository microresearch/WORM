...
3. digitalker ?? are there 2 roms? we have one large so stick with
   this, bends if any=pitch _and_ repeats/zero_count, also possible
   bend of any tables

how large is vocab in that rom?

what is that rom from? other roms? mazerbla
