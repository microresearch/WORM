...
- test each mode individually and transition between modes in one group (also between all TTS - what might they share?)

sam, digitalker-L, TMS, SP0256-L, votrax, klatt=nvp-L, simpleklatt, rsynth-2, rsynth-2005, compost in principle::: sam and klatt group as probable,
