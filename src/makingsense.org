...
- how do we hit desired ADC end value as we always seem to fall short!

fine up to 64 but above we lose the end with +1
...
rom12=mattel (why is lost before "presents"?)->aend
...
*- ported sp0256_lapraw1, raw2 to ARM-DONE-> TEST BASICS!* raw2 crashes, raw1 fixed but needs tweaking for speeds and so on
