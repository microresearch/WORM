...
- with -O2 we overflow flash by 3716 bytes, with -0s is fine... TEST
  with -Os // trimmed all so far (printf and CMSIS-in tube removed, klattTTS removed) - one TMS vocab is enough to solve overflow...

- TMS= wrapping of selection = keyword fix
