...
- raw votrax parameter codeDONE-to TEST, bending of vocabs-TODO-part_way - inc into audio.c
...
mode list +: utility and strange modes, compost modes (start/end/triggerforlastmodeparam)

** 15/2

- suspected hardware issue but was board fault (to FIX)
