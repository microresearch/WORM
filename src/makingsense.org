...
for rsynth: 2005 - python speakyr using vocab in /root/test - what is that VOCAB?
...
- when we should re-init klatt in all klatt-based modes?

- rsynthy with nelm list and single phonemes as in klatt

- all vocabs for nvp, klatt, rsynthy - see above

- summarise all klatt-based modes - add any singing modes (ie. non bends but pure pitch)
