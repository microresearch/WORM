...
- clean up sp0256 (crash proof on roms and ditch 019)

- sp0256 vocab from book to add
- sp0256 12 rom to add
- split sp0256 vocab
- test TTS votrax on ARM

- raw sp0256 - code and bend
- raw votrax
...
- resurrecting crow/Lpc: lpcanaylsis.c 
