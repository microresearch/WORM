...
- re-test all sp0256 modes, triggers and extents DONE-all good so far - stress test TTS!

- new hardware tests for ADC extents - extra board TODO

////

- announce 20 march release and do soundclouds next week
...
- stress test VOTRAX TTS-DONE, sely=pitch and selz on votrax (not TTS - could have z as TTS length there in alt TTS version - also for all TTS)!!!

- selz for other votrax: 

- raw votrax-raw code, parameter code, bending of vocabs, vocab votrax modesDONE_TEST
