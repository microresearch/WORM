...
////
6-larger selected vocab on selz (say 128) with speed AND pitch on x/y - modus=3 DONE
...
- modes: basic pitch and speed ADDED, test (not bending - also check we have this for all modes so is a bit like singing)

- TODO: table bends: pcm_levels (64), delta1 and 2 (16+16), pitch_vals (32)
