...
TODO: - what varies across coeffs and check this again - 5110=5 pitch bits =32 5200=6 pitch bits =64
...
TTS stuff: $(ttsd)/parse.o $(ttsd)/saynum.o $(ttsd)/newenglish.o $(ttsd)/phoneme.o $(ttsd)/spellwor.o \

rsynth_2005/holmes.o rsynth_2005/elements.o rsynth_2005/opsynth.o

klatt: $(rsynth-portDIR)/holmes.o \ $(rsynth-portDIR)/elements.o \
$(rsynth-portDIR)/nsynth.o $(rsynth-portDIR)/say.o \
