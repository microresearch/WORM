...
*- for nvp.c we need frame 49 as silent frame - NEARLY DONE*

** 6/4++

- check all klatt vocabs and fix nvp silence
- check sam selected vocab
- TODO for tubes: singing mode (straight freq and length), raw xy mode (16 params + reset volume thing)
- digitalker raw mode
