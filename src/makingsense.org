...
- x/y program resolved
- policy for extents (how far we go beyond and does it wrap or something in any cases?)
- look at spo256bend

// fixed bug in votrax_bend, changed x/y trigger thing and is better,
some tweaks in votrax and speed of all votrax in audio.c, still not
happy with bending of votrax so maybe ditch or...
