...
RSYNTHY: retry &58simpleklatter with different settings-stay with cascade/small changes

///// sanity/TTS/check each mode/check all modes and compost

- sanity check of all array extents, check TTS sanity AGAIN and any general stuff eg. ???
