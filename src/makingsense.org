...
- raw2 - code version on lap for sp0256: Instructions: http://spatula-city.org/~im14u2c/intv/tech/sp0256_instr_set.html DONE but port to ARM and TEST!
...
sp0256TTS, sp0256vocabone, sp0256vocabtwo, sp0256_12+JOIN+sp0256_19, sp0256rawone + 2nd raw, bending of roms, other excitations = 8+

- TEST pass excitation buffer/inverse filter to sp0256 filter for testing!

*** other

- TTS votrax port and test - try also votrax typetalk.bin

- recent BBC bins for...

-  we need to fix x, y and z also! - x-sel, y-inflection/pitch,
