...
-- bends CRASH - FIXED but esp. bend is quite dull, also extent of tubes.c postures is quite high...TRIM? - *TODO*

-- for voices we can also change wavetable for glottis - say 16 wavetables available as const - *TODO*

*- klatt: as primary here*

sources:SAMPLE, NATURAL, IMPULSIVE, TRIANGULAR, WAVETABLE, flutter, tilt, skew

- rsynth: - not so important
...
- nvp: vibrato is not so important
