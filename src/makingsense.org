...
- TODO: note also with votrax clock change on cap filters - *as extra  bend* DONE TEST
- DONEcheck filter stuff on lap (clock doesn't change filter coeffs just
  ratio between m_sclock and m_cclock) - as bend instead of lengthTEST!

- new bends/TMS modes in tms5200x.h to incorporate in audio.cDONE, TEST and select/add new vocabs - 

*/// all with tms_newsay_specific - at moment 0 for 5100, 1 for 5200 to change and add*

ADDED: tms5200ktablebend, tmsbend5100, tms5200pitchtablebend, tms5100kandpitchtablebend, tms5200kandpitchtablebend TEST all

*TODO:*

extra vocabs for these and... tmsbend5200, tms5100ktablebend, tms5100pitchtablebend = +8 say
...
- get new code base
- starting on SAM: vocablist_sam is 32 banks by 42 vocabs sely and selz
- sort out SAM mess with repeats and singmode - singmode doesn't seem to do much
- reciter.c is text to speech also
- bends for SPEED     PITCH     THROAT    MOUTH see readme notes below
...
//////////////////say 30+ so far with vocab modes/TMS = 4 weeks

5. SAM -> TTS, vocab(ported already), raw?, low pass filtered and not filtered - bend on one as we will have y/z for bank and vocab
