...
- *do we not need to do a new_say when there is a change of mode to enter the new mode?* - done in audio.c/sp0256 -> TEST
...
-- - *check adc _selx etc. extents for arrays say in sp0256 as model*
