...
limits for the 16 params... also template for that is where - now in templateDONE -> add on T60 - TO TEST
...
- compost -> in audio.c and samplerate.c STARTED
...
*- decide on all voices/klatt and tubes and implement*
